        ...
        <div class="hk-wrapper hk-vertical-nav">
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="container">
                            <button class="btn btn-primary m-4" id="print-invoice"> Print</button>
                        </div>
                        <div class="col-xl-12">
                                ...
                                <div class="invoice-from-wrap">
                                    <div class="row">
                                        <div class="col-md-7 mb-20">
                                            <h3 class="mb-35 font-weight-600"> FRTMS </h3>
                                            <h6 class="mb-5">Farm Records Tracking And Management System</h6>
                                        </div>

                                        <?php
                                        //Consumer Details
                                        $inid = $_SESSION['invoice'];
                                        $query = mysqli_query($con, "select distinct InvoiceNumber,CustomerName,CustomerContactNo,PaymentMode,InvoiceGenDate  from tblsales  where InvoiceNumber='$inid'");
                                        $cnt = 1;
                                    ...
                                    <div class="table-wrap">
                                        <table class="table mb-0" border="1">
                                            ...
                                            <tbody>
                                                <?php
                                                //Product Details
                                                $query = mysqli_query($con, "select tblproducts.CategoryName,tblproducts.ProductName,tblproducts.ProductPrice,tblsales.Quantity  from tblsales join tblproducts on tblproducts.id=tblsales.ProductId where tblsales.InvoiceNumber='$inid'");
                                                $cnt = 1;
                                                while ($row = mysqli_fetch_array($query)) {
                                                ?>
                                                    <tr>
