                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hk-row">
                                ...
                                <?php
                                $query = mysqli_query($con, "select sum(tblsales.Quantity*tblproducts.ProductPrice) as tt  from tblsales join tblproducts on tblproducts.id=tblsales.ProductId ");
                                ...
                                <?php
                                $qury = mysqli_query($con, "select sum(tblsales.Quantity*tblproducts.ProductPrice) as tt  from tblsales join tblproducts on tblproducts.id=tblsales.ProductId where date(tblsales.InvoiceGenDate)>=(DATE(NOW()) - INTERVAL 7 DAY)");
                                ...
                                <?php
                                $qurys = mysqli_query($con, "select sum(tblsales.Quantity*tblproducts.ProductPrice) as tt  from tblsales join tblproducts on tblproducts.id=tblsales.ProductId where date(tblsales.InvoiceGenDate)=CURDATE()-1");
                                ...
                                <?php
                                $quryss = mysqli_query($con, "select sum(tblsales.Quantity*tblproducts.ProductPrice) as tt  from tblsales join tblproducts on tblproducts.id=tblsales.ProductId where date(tblsales.InvoiceGenDate)=CURDATE()");
                                ...
                                <?php
                                $sql = mysqli_query($con, "SELECT SUM(Price*Quantity) AS orders from tblorders");
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <span class="d-block display-4 text-dark mb-5"><?php echo number_format($result['orders'], 2); ?></span>
                                                <small class="d-block">Total orders till date</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between mb-5">
                                                <div>
                                                    <span class="d-block font-15 text-dark font-weight-500">Total Net Profit</span>
                                                </div>
                                                <div>
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <span class="d-block display-4 text-dark mb-5"><?php echo number_format($cash_at_hand, 2); ?></span>
                                                <small class="d-block">Net profit till date</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
