                                        ...
                                        <div class="table-wrap">
                                            <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = mysqli_query($con, "select  InvoiceNumber,CustomerName,CustomerContactNo,PaymentMode,InvoiceGenDate  from tblsales where date(InvoiceGenDate) between '$fdate' and '$tdate'");
                                                    $cnt = 1;
