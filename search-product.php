...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['checkout'])) {
        ...
        foreach ($value as $pdid => $qty) {
            $query = mysqli_query($con, "insert into tblsales(ProductId,Quantity,InvoiceNumber,CustomerName,CustomerContactNo,PaymentMode) values('$pdid','$qty','$invoiceno','$cname','$cmobileno','$pmode')");
        }
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Sell Product</h4>
                    </div>
                    <!-- /Title -->
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""></label>
                                                        <select class="form-control" name="productname" id="validationCustom03">
                                                            <option>Select Product</option>
                                                            <?php
                                                            $query = mysqli_query($con, "SELECT id,ProductName FROM tblproducts ");
