...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "select ID from tblusers where ID='$adminid' and   Password='$cpassword'");
        $row = mysqli_fetch_array($query);
        if ($row > 0) {
            $ret = mysqli_query($con, "update tblusers set Password='$newpassword' where ID='$adminid'");
            ...
            <div class="hk-pg-wrapper">
                ...
                <nav class="hk-breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light bg-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php if ($_SESSION['role'] == 'user') {
                                                                                    echo 'User';
                                                                                } else {
                                                                                    echo 'Admin';
                                                                                }
