...
<h6 class="mb-5">Farm Record Tracking and Management Sytem</h6>
...
$query=mysqli_query($con,"SELECT  InvoiceNumber,CustomerName,CustomerContactNo,PaymentMode,InvoiceGenDate  from tblsales where InvoiceNumber='$inid'");
$cnt=1;
